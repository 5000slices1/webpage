...
import { idlFactory } from './web3.did.js';
export { idlFactory } from './web3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WEB3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web3.did.js")._SERVICE>}
 */
