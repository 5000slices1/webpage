...
export const walletList = [
    {
        ...
        icon: BaseUrl + 'assets/dfinity.svg',
        adapter: dfinity,
    },
    {
        id: 'plug',
        name: 'Plug Wallet',
        icon: BaseUrl + 'assets/plug.jpg',
        adapter: plug,
    },
    ...
    //     icon: BaseUrl + 'assets/bitfinity.svg',
    //     adapter: bitfinity,
    // },
    {
        id: 'stoic',
        name: 'Stoic Wallet',
        icon: BaseUrl + 'assets/stoic.png',
        adapter: stoic,
    },
    // {
    //     id: 'nfid',
    //     name: 'NFID',
    //     icon: BaseUrl + 'assets/nfid.svg',
    //     adapter: nfid,
    // },
    // {
    //     id: 'metamask',
    //     name: 'MetaMask',
    //     icon: BaseUrl + 'assets/metamask.svg',
    //     adapter: metaMask,
    // },
